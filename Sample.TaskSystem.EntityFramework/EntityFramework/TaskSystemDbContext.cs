...
namespace Sample.TaskSystem.EntityFramework
{
    public class TaskSystemDbContext : AbpZeroDbContext<Tenant, Role, User>
    {
        ...
        public TaskSystemDbContext(DbConnection existingConnection)
         : base(existingConnection, false)
        {

        }

        public TaskSystemDbContext(DbConnection existingConnection, bool contextOwnsConnection)
