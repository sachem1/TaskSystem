...
{
    public abstract class TaskSystemTestBase : AbpIntegratedTestBase<TaskSystemTestModule>
    {
        ...
        protected Task UsingDbContextAsync(Func<TaskSystemDbContext, Task> action)
        {
        ...
        protected Task<T> UsingDbContextAsync<T>(Func<TaskSystemDbContext, Task<T>> func)
        {
            return UsingDbContextAsync(AbpSession.TenantId, func);
        }

        protected void UsingDbContext(int? tenantId, Action<TaskSystemDbContext> action)
        {
        ...
        protected async Task UsingDbContextAsync(int? tenantId, Func<TaskSystemDbContext, Task> action)
        {
            using (UsingTenantId(tenantId))
            {
                using (var context = LocalIocManager.Resolve<TaskSystemDbContext>())
        ...
        protected T UsingDbContext<T>(int? tenantId, Func<TaskSystemDbContext, T> func)
        {
            T result;
        ...
        protected async Task<T> UsingDbContextAsync<T>(int? tenantId, Func<TaskSystemDbContext, Task<T>> func)
        {
            T result;
